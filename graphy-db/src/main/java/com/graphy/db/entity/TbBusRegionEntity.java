 ...
 */
@Data
@TableName("tb_bus_region")
@JsonInclude(JsonInclude.Include.NON_NULL)
@ApiModel(value = "TbBusRegionEntity对象", description = "业务-行政区划")
public class TbBusRegionEntity implements Serializable{
    ...
    * 父节点 根节点=0
    */
    @ApiModelProperty(value = "父节点 根节点=0")
    @TableField("PCODE_")
