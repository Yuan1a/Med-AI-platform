 ...
 */
@Data
@TableName("tb_platform_code_type")
@JsonInclude(JsonInclude.Include.NON_NULL)
@ApiModel(value = "TbPlatformCodeTypeEntity对象", description = "系统-字典类别")
public class TbPlatformCodeTypeEntity implements Serializable{
