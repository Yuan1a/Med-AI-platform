 ...
 */
@Data
@TableName("tb_platform_role")
@JsonInclude(JsonInclude.Include.NON_NULL)
@ApiModel(value = "TbPlatformRoleEntity对象", description = "系统-角色信息")
public class TbPlatformRoleEntity implements Serializable{
