package com.graphy.unit.verifycode;
...
public class Api {
    ...
    * @return
    */
   public static VerifyCodeInfo getVerifyCode() {
      Api verifycode = new Api();
      VerifyCodeInfo codeInfo = new VerifyCodeInfo();
      codeInfo.setImage(verifycode.getImage());
      codeInfo.setCode(verifycode.getText());
      return codeInfo;
   }
